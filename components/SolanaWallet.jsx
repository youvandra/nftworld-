       ...
       <Row>
         <Col span={12}>
           <Network onClick={() => openSolana()}>
             <img src={'https://cryptologos.cc/logos/solana-sol-logo.svg?v=024'} alt='Solana' width='32' height='32' />
             <p>Solana</p>
           </Network>
         </Col>
         <Col span={12}>
           <Network onClick={() => openETH()}>
           <svg width="32" height="32" viewBox="0 0 1440 1024" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <Row>
            <Col span={12}>
              <Network onClick={() => connectETHWallet()}>
                <img src={'https://upload.wikimedia.org/wikipedia/commons/thumb/3/36/MetaMask_Fox.svg/768px-MetaMask_Fox.svg.png'} alt='metamask' width='32' height='32' />
                <p>Metamask</p>
              </Network>
            </Col>
            <Col span={12}>
              <Network onClick={() => connectETHWallet()}>
                <img src={'https://trustwallet.com/assets/images/media/assets/TWT.png'} alt='trust-wallet' width='32' height='32' />
                <p>Trust Wallet</p>
              </Network>
            </Col>
          </Row>
